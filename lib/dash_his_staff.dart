...
class Dash_his_staff extends StatefulWidget {
  const Dash_his_staff({super.key});

  @override
  _Dash_his_staffState createState() => _Dash_his_staffState();
}

class _Dash_his_staffState extends State<Dash_his_staff> {
  ...
  Future<void> fetchRequestHistory() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.1.111:3000/requestHistoryStaff'));
              ...
              ...requests.reversed.map((request) {
                ...
                return DetailedRequestCard(
                  ...
                  details: [
                    ...
                    'Date: ${request.date}',
                    'Approver: ${request.approverFirstName} ${request.approverLastName}',
